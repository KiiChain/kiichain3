...
cat ~/.kiichain3/config/genesis.json | jq '.app_state["oracle"]["params"]["whitelist"]=[{"name": "ubtc"},{"name": "ueth"},{"name": "usol"},{"name": "uxrp"},{"name": "ubnb"},{"name": "uusdt"},{"name": "uusdc"}]' > ~/.kiichain3/config/tmp_genesis.json && mv ~/.kiichain3/config/tmp_genesis.json ~/.kiichain3/config/genesis.json
